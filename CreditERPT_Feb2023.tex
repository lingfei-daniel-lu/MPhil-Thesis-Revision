...
We acknowledge that manufacturing firms used in the estimation of exchange rate pass-through involve different types of trade. We will perform two tests to control the effects of trade modes on our main estimation.
