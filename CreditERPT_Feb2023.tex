...
We acknowledge that manufacturing firms used in the estimation of exchange rate pass-through involve different types of trade. We will perform two groups of tests to control different trade modes in our estimation of pass-through.
...
Table \ref{tab.robust.tradetype} shows that the results after controlling for two-way trade and processing trade are highly similar to the results for the entire matched sample.
