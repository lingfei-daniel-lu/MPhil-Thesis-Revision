...
\begin{table}[htbp]
	...
	\resizebox{\textwidth}{!}{
		\begin{threeparttable}
			...
			\begin{tablenotes}
				\footnotesize
				\item[Notes:] This table shows the summary statistics of credit constraint measures. Panel A describes the measures calculated using US data, while panel B shows the alternative measures from Chinese data. All variables are unitless, and the numerical size only means an ordinal ranking.
			\end{tablenotes}
		\end{threeparttable}
	}
\end{table}
