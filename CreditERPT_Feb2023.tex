...
\begin{sidewaystable}[htbp]
	...
	\begin{threeparttable}
		\begin{tabular}{lcccccccc}
			...
			&       & &Finance & &       & &Finance &			\\
			\midrule
			$\Delta \ln RER_{ct}$ & 0.927*** & 0.508*** & 2.417*** & 1.386*** & 0.912*** &0.514*** &0.655*** &2.322***\\
		...
		\begin{tablenotes}
			\footnotesize
			\item[Notes:] Standard errors in parentheses; *, **, and *** indicate significance at 10\%, 5\% and 1\% levels. The dependent variable is the price change $\Delta \ln P_{ijct}$. Columns (1)-(4) use the number of source countries at the current year while columns (5)-(8) use the number of source countries at the initial year. All regressions include firm-product-country fixed effects and year fixed effects.
		\end{tablenotes}
	\end{threeparttable}
	}
	\label{tab.source}
