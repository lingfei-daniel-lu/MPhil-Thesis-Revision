...
\begin{sidewaystable}[htbp]
	...
	\begin{threeparttable}
		\begin{tabular}{lcccccccc}
			...
			&       & &Finance & &       & &Finance &			\\
			\midrule
			$\Delta \ln RER_{ct}$ & 0.926*** & 0.532*** & 0.676*** & 2.331*** & 0.905*** & 0.531*** & 0.663*** & 2.232*** \\
			& (0.055) & (0.058) & (0.055) & (0.146) & (0.054) & (0.059) & (0.054) & (0.147)\\
			$\Delta \ln RGDR_{ct}$ & 0.182 & 0.119 & 0.118 & 0.147 & 0.182 & 0.121 & 0.120 & 0.148 \\
			& (0.127) & (0.127) & (0.127) & (0.127) & (0.127) & (0.127) & (0.127) & (0.127)  \\
			$\#Source_{ijt}$ & -0.056*** & -0.056*** & -0.054*** & -0.076***  & -0.061*** & -0.068*** & -0.062*** & -0.068** \\
			& (0.009) & (0.010) & (0.009) & (0.024) & (0.010) & (0.012) & (0.010) & (0.028) \\
			$\Delta \ln RER_{ct}*FPC_{j}*\#Source_{ijt}$ &       & -0.014** &       & 	&       & -0.009 & &\\
			&       & (0.007) &       &  &       & (0.009) &       &\\
...
\begin{table}[htbp]
	...
	\begin{tabular}{lccccc}
		...
		\midrule
		$\Delta \ln RER_{ct}$ & 0.641*** & 0.931*** & 3.398*** & -0.958*** & 0.229** \\
		& (0.069) & (0.112) & (0.391) & (0.269) & (0.110) \\
		$\Delta \ln RGDP_{ct}$ & 0.210 & 0.190 & 0.179 & 0.205 & 0.197 \\
		&  (0.183) & (0.183) & (0.182) & (0.183) & (0.182) \\
            $\Delta \ln RER_{ct}$*$FPC_{j}$ & -0.192*** &       &       &       &  \\
            & (0.074) &       &       &       &  \\
		$\Delta \ln RER_{ct}$*$ExtFin_{j}$ & & 0.326** &       &       &  \\
		& &(0.134) &       &       &  \\
		$\Delta \ln RER_{ct}$*$Tang_{j}$ &  &  & -9.257*** &       &  \\
		&       & &(1.279) &       &  \\
		$\Delta \ln RER_{ct}*Invent_{j}$ &       &       & &14.763*** &  \\
		&       &       &  &(2.445) &  \\
		$\Delta \ln RER_{ct}*R\&D_{j}$ &       &       &   &    & 25.342*** \\
		&       &       &       & & (5.221) \\
	...
	\resizebox{\textwidth}{!}{
		\begin{threeparttable}
			\begin{tabular}{lcccccccc}
				...
				&       & &Finance & &       & &Finance &			\\
				\midrule
				$\Delta \ln RER_{ct}$ & 1.069*** & 0.462***	& 0.657*** & 2.629*** & 1.102*** &	0.445*** & 0.656***	& 2.782***\\
				& (0.108) & (0.117) & (0.101) & (0.415) & (0.043) & (0.050) & (0.045) & (0.111)\\
				$\Delta \ln RGDR_{ct}$ & 0.083 & 0.050 & 0.037 & 0.074 & 0.064 & 0.028 & 0.014 & 0.054\\
				& (0.189) & (0.188) & (0.188) & (0.189) & (0.116) & (0.116) & (0.116) & (0.116) \\
				$ Distance_{ijt}$ & -0.085*** & -0.034** & -0.050*** & -0.187*** & -0.085*** & -0.030* & -0.047*** & -0.192*** \\
				& (0.018) & (0.015) & (0.015) & (0.063) & (0.019) & (0.016) & (0.016) & (0.068) \\
				$\Delta \ln RER_{ct}*FPC_{j}*Distance_{ijt}$ &       & -0.063*** &       & 	&       & -0.068*** & &\\
				&       & (0.021) &       &  &       & (0.022) &       &\\
				$\Delta \ln RER_{ct}*FPC_{j}$ &       & 0.807*** &       &  &       & 0.829*** &       &\\
				&       & (0.141) &       & &       & (0.146) &       & \\
				$\Delta \ln RER_{ct}*ExtFin_{j}*Distance_{ijt}$ &       &    &   -0.221*** &  &       &    &   -0.242*** &\\
				&       &       & (0.057) &  &       &       & (0.062) &\\
				$\Delta \ln RER_{ct}*ExtFin_{j}$ &       &       & 2.654*** &   &       &       & 2.740*** &\\
				&       &       & (0.421) &  &       &       & (0.437) &\\
